...
export class TimelineComponent implements OnInit {
  ...
  @Output('children') childrenView = new EventEmitter<any>();
  ...
  ngOnInit() {
    ...
    this.req.getData('assets/map/data-1528971808162-BkOXf61WX.json').subscribe(res => {
    ...
    this.myChart.on('click', function(event){
      let data = {'name': event.name, 'status': true};
      that.childrenView.emit(data);
    })
  }
